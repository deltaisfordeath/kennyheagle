...
export const VERIZON_EXPERIENCE: VerizonExperienceOutcome[] = [
    ...
    },
    {
        ...
        solution: "In addition to implementing a function to align multiple selected drawings along their left, right, top, bottom, or center axis, I also considered that 'grouped' drawings should be treated as a single unit, maintaining their position relative to their groupmates. I also built the toolbar menu for quick access to the new alignment features.",
    ...
    },
    {
        ...
        solution: "I developed three features to greatly enhance the user experience when scaling shapes. First was the creation of perfectly squared drawings by holding the shift key while resizing, or double click any of the resize handles of a drawing to instantly square the aspect ratio of the drawing along the clicked axis. Second was creation of perfectly straight lines along an x or y axis by holding the shift key while drawing. Third was displaying a popper with the pixel width and height of the drawing while creating or resizing, allowing for superb control over the relative sizes of shapes on the board.",
    ...
    },
    {
        ...
        solution: 'Working with a back-end developer, I developed the functionality to submit whiteboard drawing data and an HTML canvas screenshot to an api endpoint that would store the data as a reusable template. The user would simply lay out any drawings they want to reuse and then click a save button on the toolbar. The template would then appear on a modal I created, allowing the user one-click access to all of their reusable templates.',
    ...
    },
    {
        ...
        solution: 'I implemented a feature allowing a user to change a shape in-place without altering any styles or connections. I also developed a context-based toolbar menu to easily access changing one two-dimensional shape to another, or one connector line type to another.',
